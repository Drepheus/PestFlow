...
export const BlogPage = () => {
    // Initialize with the data from the file so it's never empty
    const [posts, setPosts] = useState<BlogPost[]>(initialBlogs as BlogPost[]);

    useEffect(() => {
        const fetchPosts = async () => {
            try {
                // Try to get fresh data, but don't clear existing data if it fails
                ...
                // Silently fail to localhost in production and keep static data
